...
png("plot3.png")
plot(filteredPowerData$Date, as.numeric(filteredPowerData$Sub_metering_1), type = "l", xlab ="", ylab = "Energy sub metering", main = "", col="black")
lines(filteredPowerData$Date, as.numeric(filteredPowerData$Sub_metering_2), type = "l", col="red")
lines(filteredPowerData$Date, as.numeric(filteredPowerData$Sub_metering_3), type = "l", col="blue")
